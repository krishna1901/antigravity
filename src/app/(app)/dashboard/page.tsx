...
import { Lightbulb, Send, Calendar, MessageSquare, Plus, PenSquare, Image as ImageIcon, Edit2, Trash2, Instagram, Twitter, Linkedin, Check } from "lucide-react";
...
export default async function DashboardPage() {
  ...
  const getPlatformIcon = (platform: string) => {
    switch (platform) {
      ...
      default: return <Linkedin className="h-4 w-4 text-blue-700" />;
    }
  };
